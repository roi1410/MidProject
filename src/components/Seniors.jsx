      ...
      <blockquote className="c-quote p-8 bg-white shadow-md rounded-lg">
        <div className="c-block__quote-content an-will-animate an-was-on-viewport an-on-viewport an-on-viewport-mid an-on-viewport-full">
          ...
          <div className="c-quote__cite-text">
            ...
            <div className="c-quote__quote-cta mt-4">
              <a href="https://gsas.harvard.edu/news/hungry-change" className="a-btn a-btn-secondary a-btn--arrow-right">
        ...
        <cite className="c-quote__cite an-will-animate an-was-on-viewport an-on-viewport an-on-viewport-mid an-on-viewport-full">
          <span className="c-quote__cite-figure c-image">
            <img src="https://www.harvard.edu/wp-content/uploads/2023/08/LeahGose-copy-624x624.jpg" alt="A woman stands outside, resting her arm on a brick wall" className="c-quote__cite-image c-image__image"/>
          </span>
        </cite>
      </blockquote>
    </div>
